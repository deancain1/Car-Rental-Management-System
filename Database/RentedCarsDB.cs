...
namespace Carl_Rental_System.Database
{
    public class RentedCarsDB
    {
        ...
        public void TransferRentedCarToReturned(int CarRentedID)
        {
            ...
            string InsertQuery = "INSERT INTO ReturnedCar (FullName, Role, PhoneNumber, Brand, Model, Price, Tax, DailyRate, " +
            ...
            using (SqlConnection conn = new SqlConnection(ConnectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand(InsertQuery, conn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Brand", rentedCarsModel.Brand);
