        ...
        public static void RentedCars(RentedCarsModel rentedCars)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnectionString))
                {
                    ...
                    string carQuery = "INSERT INTO RentedCars (Brand, Model, Price, Tax, Subtotal, Total, Seats, Gas, Transmission, CarImage, PickUpDate, DropOffDate, Quantity) VALUES (@Brand, @Model, @Price, @Tax, @Subtotal, @Total, @Seats, @Gas, @Transmission, @CarImage, @PickUpDate, @DropOffDate, @Quantity)";
