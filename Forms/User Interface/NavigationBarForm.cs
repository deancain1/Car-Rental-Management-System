...
namespace Carl_Rental_System.Forms.User_Interface
{
    public partial class NavigationBarForm : Form
    {
        ...
        private void BookingBtn_MouseMove(object sender, MouseEventArgs e)
        {
            BookingBtn.BackColor = Color.SlateBlue;
        }
        private void BookingBtn_MouseLeave(object sender, EventArgs e)
        {
            BookingBtn.BackColor = Color.DarkSlateBlue;
        }
